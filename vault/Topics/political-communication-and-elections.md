...
Empirical studies of political news coverage, partisan attention, hyperpartisan networks and polarization dynamics around national and European elections (Italy, Germany, Brazil), a long-running core strand of the MINE programme.
...
```dataview
LIST FROM "Papers"
WHERE contains(topics, "political-communication-and-elections")
